 ...
 * scripts.
 *
 * For beta testing, wrap beta code in a BETA block. i.e.
 * if (BETA) {
 *   mybetacode();
 * } // BETA
 *
  ...
  switch (masterSite.urlType) {
    ...
    case URL_TYPES.loginPage:
      ...
      if(site.loginIsAjax && !isListeningAjax) {
        ...
        onBeforeAjaxRequest =
          onBeforeAjaxRequest.bind(null, masterSite.name, site, tab.id);
