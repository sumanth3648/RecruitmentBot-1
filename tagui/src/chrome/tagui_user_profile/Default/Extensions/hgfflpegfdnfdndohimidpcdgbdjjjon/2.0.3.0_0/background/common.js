...
'use strict';
/**
 * Configuration of beta features.
 */
const BETA = false;
...
var SITES = {
  Facebook: {
    ...
    changePasswordURL:
      /^https:\/\/.*\.facebook\.com\/settings\?tab=security&section=password&view/,
  ...
  'Intern': {
    ...
    bootstrapURL: 'https://our.internmc.facebook.com/intern/employee/login/',
    cookieDomain: 'https://www.facebook.com',
...
const OPTIONS_URL = 'https://our.intern.facebook.com/intern/security/protego/options/';
const OPTIONS_PATT = /^https:\/\/.*\.?(facebook|internalfb)\.com\/intern\/security\/protego\/options\/?/;

const PASTEBIN_URL = 'https://our.intern.facebook.com/intern/security/protego/pastebin/';
const PASTEBIN_PATT = /^https:\/\/.*\.?(facebook|internalfb)\.com\/intern\/security\/protego\/pastebin\/?/;

const DOWNLOADS_URL = 'https://our.intern.facebook.com/intern/security/protego/download/';
const DOWNLOADS_PATT = /^https:\/\/.*\.?(facebook|internalfb)\.com\/intern\/security\/protego\/download\/?/;

const SETTINGS_PAGE_SHIM = 'chrome-extension://'+chrome.runtime.id+'/content/settings/index.html';
...
const WHITELIST_LABEL = "\u{2713}";
const WARNING_LABEL = "!";
const PHISH_LABEL = "SENT";

// text
const LOGIN_TXT = "Login Page";
const WHITELIST_TXT = "Whitelisted Page";
